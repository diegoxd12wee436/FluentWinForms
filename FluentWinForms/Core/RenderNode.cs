...
namespace FluentWinForms.Core
{
    ...
    public sealed class RenderNode
    {
        ...
        [Browsable(false)] internal Color _lastShadowColor = Color.Empty;
        ...
        [Browsable(false)] internal SKRect _lastAcrylicRect;
        [Browsable(false)] internal float _lastAcrylicCorner = -1f;
        [Browsable(false)] internal SKImageFilter? _cachedFilterImageFilter;
        [Browsable(false)] internal SKColorFilter? _cachedFilterColorFilterOnly;
        [Browsable(false)] internal float _lastFilterBlur = -1f;
        [Browsable(false)] internal float _lastFilterGrayscale = -1f;
        [Browsable(false)] internal float _lastFilterBrightness = -1f;
        [Browsable(false)] internal float _lastFilterContrast = -1f;
        internal void ReleaseNativeResources()
        {
            ...
            _cachedAcrylicGlowPaint = null;
            _cachedAcrylicClipPath?.Dispose();
            _cachedAcrylicClipPath = null;
            _cachedFilterImageFilter?.Dispose();
            _cachedFilterImageFilter = null;
            _cachedFilterColorFilterOnly?.Dispose();
            _cachedFilterColorFilterOnly = null;
            SvgPicture?.Dispose();
            SvgPicture = null;
